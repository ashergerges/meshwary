    ...
    return BlocProvider(
      ...
      child: BlocConsumer<AuthenticationCubit, AuthenticationStates>(
        ...
        builder: (context, state) {
          ...
          cubit.nameUserProfileController.text=model.name;
          cubit.phoneUserProfileController.text=model.phone;
                ...
                child: Column(
                  children: [
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            ...
                            controller: cubit.nameUserProfileController,
                    ...
                    TextFormField(
                      ...
                      controller: cubit.phoneUserProfileController,
                      decoration: const InputDecoration(
                        ...
                        child: TextButton(
                          ...
                          onPressed: (){
                            if(cubit.updateImage == null){
                              if(cubit.formKeyUpdateUser.currentState!.validate()){
                                cubit.updateWithoutImageUser(
                                  name:cubit.nameUserProfileController.text ,
                                  phone: cubit.phoneUserProfileController.text,
                                  context:context ,
                                  uId: model.id,
                                );
                                //updatawithout image
