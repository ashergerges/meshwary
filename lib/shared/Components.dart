...
Widget extension(String ex,BuildContext context)
{
  return Row(
    children: [
      SizedBox(
        width: sizeFromWidth(context, 120),
      ),
      Text(
        ex,
        style: TextStyle(
...
Widget itemU(String text,IconData icon)
{
  return Row(
    children: [
      Icon(icon),
...
Widget extensionU(String ex,BuildContext context)
{
  return Row(
    children: [
      SizedBox(
